...
| Add 9 (minor) | m(add9) | 1–♭3–5–9 | [0,3,7,14] | minor | ✓ |
...
| Augmented 7 | 7(♯5) | 1–3–♯5–♭7 | [0,4,8,10] | augmented | ✓ (symbol: aug7) |
...
All chords in this reference are implemented in `chords.js`. The library covers:

- All standard tertian families: major, minor, dominant, diminished, augmented, suspended
- Classical: Neapolitan (N6), Italian +6, French +6, German +6
- Quartal/quintal: qrt3, qrt4, qrt5 (So What), qrtTT, qnt3, qnt4
- Cluster/secundal: clust_M2_3, clust_m2_3, clust_mix_4, clust_chr_4
